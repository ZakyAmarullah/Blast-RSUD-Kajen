        ...
        <header class="bg-white border-b border-gray-200 px-6 py-3.5 flex items-center gap-3 shrink-0">
            ...
            <div class="ml-auto flex items-center gap-3">
                ...
                <button class="flex items-center gap-2 hover:bg-gray-50 px-2 py-1 rounded-lg transition-colors">
                    <div
                        class="w-8 h-8 bg-[#1e6b45] text-white rounded-full flex items-center justify-center font-semibold text-sm">
        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-gray-500 mt-0.5">
                    Berikut ringkasan aktivitas <span class="text-[#1e6b45] font-semibold">Poli Penyakit Dalam</span>
                    hari ini.
                </p>
            </div>
            <!-- Stats Cards -->
                ...
                <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                    <div class="flex items-start gap-3 mb-3">
                        <div class="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 text-orange-400" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div class="p-5 flex items-center gap-4">
                        ...
                        <div class="text-right shrink-0">
                            ...
                            <span
                                class="inline-block bg-red-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full">Berhalangan</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex gap-4 text-[10px] text-gray-500">
                            <span class="flex items-center gap-1"><span
                                    class="w-2 h-2 rounded-full bg-green-500 inline-block"></span> Berhasil
                                (98%)</span>
                            <span class="flex items-center gap-1"><span
                                    class="w-2 h-2 rounded-full bg-red-500 inline-block"></span> Gagal (2%)</span>
                            <span class="flex items-center gap-1"><span
                                    class="w-2 h-2 rounded-full bg-blue-400 inline-block"></span> Belum Dibaca
                                (23%)</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
                ...
                <div class="divide-y divide-gray-50">
                    ...
                    <div class="flex items-center gap-4 px-5 py-3.5">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-semibold text-gray-800">Broadcast dikirim untuk dr. Andi (Penyakit
                                Dalam)</p>
                    ...
                    <div class="flex items-center gap-4 px-5 py-3.5">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500">Reschedule: 16, Batal: 6, Dokter Pengganti: 4, Lainnya: 2
                            </p>
                        </div>
                    ...
                    <div class="flex items-center gap-4 px-5 py-3.5">
                        <div class="w-9 h-9 bg-orange-50 rounded-full flex items-center justify-center shrink-0">
                            <svg class="w-4 h-4 text-orange-400" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
