...
<body class="bg-gray-100 text-gray-800 font-sans flex h-screen overflow-hidden">
                            ...
                            <div class="px-6 py-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-[2fr_1.2fr_1.8fr] gap-5 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <div class="flex items-center gap-3 w-full h-16 border border-gray-300 rounded-lg px-3 bg-white cursor-pointer hover:border-[#1e6b45] transition-colors select-none">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <p class="text-sm font-semibold text-gray-800 leading-none" id="display-dokter-nama">dr. Edy Purwanto, Sp.PD, M.Kes</p>
                                                    <p class="text-xs text-gray-500 mt-0.5" id="display-dokter-spesialis">Spesialis Penyakit Dalam</p>
                                                </div>
                                                <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/>
                                                </svg>
                                            </div>
                                            <select id="input-dokter" class="absolute inset-0 opacity-0 w-full h-full cursor-pointer z-10">
                                                <option value="dr. Edy Purwanto, Sp.PD, M.Kes" data-sp="Spesialis Penyakit Dalam">dr. Edy Purwanto, Sp.PD, M.Kes</option>
                                                <option value="dr. Rosidi, Sp.PD" data-sp="Spesialis Penyakit Dalam">dr. Rosidi, Sp.PD</option>
                                                <option value="drg. Nurul Shofri Afifah, Sp. KG" data-sp="Spesialis Gigi">drg. Nurul Shofri Afifah, Sp. KG</option>
                                                <option value="drg. Gunarti., M.K.M." data-sp="Spesialis Gigi">drg. Gunarti., M.K.M.</option>
                                                <option value="dr. Lily Gunawan, M.Kes" data-sp="Spesialis Umum">dr. Lily Gunawan, M.Kes</option>
                                                <option value="dr. Siti Hanah" data-sp="Spesialis Umum">dr. Siti Hanah</option>
                                                <option value="dr. Lanjar Raharjoyo, Sp.JP" data-sp="Spesialis Penyakit Jantung dan Pembuluh Darah">dr. Lanjar Raharjoyo, Sp.Jp</option>
                                                <option value="dr. Guntur Susetyo, Sp.M, M.Sc" data-sp="Spesialis Mata">dr. Guntur Susetyo, Sp.M, M.Sc</option>
                                                <option value="dr. Mansur, Sp.PD" data-sp="Spesialis Penyakit Dalam">dr. Mansur, Sp.PD</option>
                                                <option value="dr. Yusuf Hakim Aji, Sp.PD" data-sp="Spesialis Penyakit Dalam">dr. Yusuf Hakim Aji, Sp.PD</option>
                                                <option value="dr. Arif Dharmawan, Sp.OG., M.Kes" data-sp="Spesialis Kandungan">dr. Arif Dharmawan, Sp.OG., M.Kes</option>
                                                <option value="dr. JatiNingsih, Sp.OG" data-sp="Spesialis Kandungan">dr. JatiNingsih, Sp.OG</option>
                                                <option value="dr. Dewi Susilowati, Sp.OG., M.K.M." data-sp="Spesialis Kandungan">dr. Dewi Susilowati, Sp.OG., M.K.M.</option>
                                                <option value="dr. Ilham Ramadhanis, Sp.OG" data-sp="Spesialis Kandungan">dr. Ilham Ramadhanis, Sp.OG</option>
                                                <option value="dr. Dony Kurniadi Wibowo, Sp.B" data-sp="Spesialis Bedah">dr. Dony Kurniadi Wibowo, Sp.B</option>
                                                <option value="dr. Herry Maha putra Surbakti, M.Biomed, Sp.B" data-sp="Spesialis Bedah">dr. Heri Maha putra Surbakti, M.Biomed, Sp.B</option>
                                                <option value="dr. Natasha Aurellia H., M.Biomed, Sp.B" data-sp="Spesialis Bedah">dr. Natasha Aurellia H., M.Biomed, Sp.B</option>
                                                <option value="dr. Rendy Yoga Ardian, Sp.A,MARS" data-sp="Spesialis Anak">dr. Rendy Yoga Ardian, Sp.A,MARS</option>
                                                <option value="dr. Arya Adnan Fadilah, M.SC., Sp.A" data-sp="Spesialis Anak">dr. Arya Adnan Fadilah, M.SC., Sp.A</option>
                                                <option value="dr. Safero Iman Hari Suku, Sp.OT" data-sp="Spesialis Orthopedi">dr. Safero Iman Hari Suku, Sp.OT</option>
                                                <option value="dr. Yusuf Khairul, Sp.OT" data-sp="Spesialis Orthopedi">dr. Yusuf Khairul, Sp.OT</option>
                                                <option value="dr. Ragil Adi Sampurna, Sp.N" data-sp="Spesialis Saraf">dr. Ragil Adi Sampurna, Sp.N</option>
                                                <option value="dr. Robby Cahyadi, Sp.KFR" data-sp="Spesialis Rehab Medik">dr. Robby Cahyadi, Sp.</option>
                                                <option value="dr. Rachmawati, Sp.KJ" data-sp="Spesialis Kesehatan Jiwa">dr. Rachmawati, Sp.KJ</option>
                                                <option value="dr. Ronald Pascal Kelejan, Sp. THT-BKL" data-sp="Spesialis THT-KL">dr. Ronald Pascal Kelejan, Sp. THT-BKL</option>
                                                <option value="dr. Yefta, M.sc., M.H., Sp.D.V.E." data-sp="Spesialis Kulit dan Kelamin">dr. Yefta, M.sc., M.H., Sp.D.V.E.</option>
                                                <option value="dr. Ika Rizky Kurniaty, Sp. DV" data-sp="Spesialis Kulit dan Kelamin">dr. Ika Rizky Kurniaty, Sp. DV</option>
                                                <option value="dr. Tegar Chandra Bondan R., Sp.M" data-sp="Spesialis Mata">dr. Tegar Chandra Bondan R., Sp.M</option>
                                                <option value="dr. Sutanto, Sp.S" data-sp="Spesialis Saraf">dr. Sutanto, Sp.S</option>
                                                <option value="dr. Safina Mutmainnah, Sp.P" data-sp="Spesialis Paru">dr. Safina Mutmainnah, Sp.P</option>
                                                <option value="dr. Mia Intan Annisa, Sp. KFR" data-sp="Spesialis Rehab Medik">dr. Mia Intan Annisa, Sp. KFR</option>
                                                <option value="dr. Alfiani Nurrahmah, Sp. KJ" data-sp="Spesialis Kesehatan Jiwa">dr. Alfiani Nurrahmah, Sp. KJ</option>
                                                <option value="dr. Nurjaya Adi Nugroho, M.Biomed, Sp. B" data-sp="Spesialis Bedah">dr. Nurjaya Adi Nugroho, M.Biomed, Sp. B</option>
                                                <option value="dr. Hanif Hary Setyawan, Sp.A" data-sp="Spesialis Anak">dr. Hanif Hary Setyawan, Sp.A</option>
                                                <option value="dr. Ratri Dian Pratiwi, Sp.PD" data-sp="Spesialis Penyakit Dalam">dr. Ratri Dian Pratiwi, Sp.PD</option>   
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input
                                                ...
                                                class="w-full h-16 border border-gray-300 rounded-lg px-3 text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-[#1e6b45] focus:border-[#1e6b45] transition-colors pr-4 cursor-pointer font-medium"
                                            >
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="relative flex-1">
                                                <input
                                                    ...
                                                    name="jam_mulai"
                                                    value="09:00"
                                                    class="w-full h-16 border border-gray-300 rounded-lg px-3 text-sm text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-[#1e6b45]/30 focus:border-[#1e6b45] transition-colors pr-4 font-medium"
                                                >
                                            </div>
    ...
    <script>
        ...
        // Live update selected dokter display on dropdown change
        function updateSelectedDokterDisplay() {
            if (!inputDokter) return;
            const selectedOption = inputDokter.options[inputDokter.selectedIndex];
            if (selectedOption) {
                const namaDokter = selectedOption.value;
                const spesialisDokter = selectedOption.getAttribute('data-sp') || 'Spesialis Dokter';

                const nameEl = document.getElementById('display-dokter-nama');
                const specEl = document.getElementById('display-dokter-spesialis');

                if (nameEl) nameEl.textContent = namaDokter;
                if (specEl) specEl.textContent = spesialisDokter;
            }
        }

        if (inputDokter) {
            inputDokter.addEventListener('change', updateSelectedDokterDisplay);
            updateSelectedDokterDisplay();
        }
    </script>
</body>
</html>
