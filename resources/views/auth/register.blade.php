    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] flex items-center justify-center min-h-screen p-6 font-sans">
        <div class="w-full max-w-[440px] flex flex-col gap-6">
            ...
            <div class="bg-white dark:bg-[#161615] rounded-2xl shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06),0px_8px_16px_-4px_rgba(0,0,0,0.04)] border border-[#19140015] dark:border-[#3E3E3A] p-8 relative overflow-hidden transition-all duration-300 hover:shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_4px_8px_0px_rgba(0,0,0,0.04),0px_16px_32px_-8px_rgba(0,0,0,0.08)]">
                ...
                <div class="absolute -top-24 -right-24 w-48 h-48 bg-[#F53003]/5 dark:bg-[#F61500]/10 rounded-full blur-3xl pointer-events-none"></div>
                <div class="absolute -bottom-24 -left-24 w-48 h-48 bg-amber-500/5 dark:bg-amber-500/10 rounded-full blur-3xl pointer-events-none"></div>
                ...
                <div class="relative">
                    ...
                    <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-6">
                        Silakan daftarkan akun Anda dengan mengisi data di bawah ini.
                    </p>
                    ...
                    <form action="{{ route('register.submit') }}" method="POST" class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-1.5">
                            <label for="username" class="text-xs font-semibold text-[#1b1b18]/80 dark:text-white/80 uppercase tracking-wider">
                                Username
                            </label>
                            <input 
                                type="text" 
                        ...
                        <button 
                            type="submit" 
                            class="w-full mt-2 px-5 py-3 bg-[#1b1b18] dark:bg-[#eeeeec] text-white dark:text-[#1C1C1A] hover:bg-black dark:hover:bg-white border border-transparent dark:border-transparent font-medium rounded-xl text-sm transition-all shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] cursor-pointer"
                        >
                            Daftar Sekarang
                        </button>
                        <a href="{{ route('login') }}" class="text-sm font-medium text-[#0071BC] dark:text-[#38bdf8] hover:underline">
                    Sudah punya akun?
                </a>
                    </form>
                </div>
